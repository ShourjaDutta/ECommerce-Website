<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="https://www.google.com/myplace"><i class="fas fa-map-marker-alt"></i> kolkata, india - 700084 </a>
      </div>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>Admin</span> | all rights reserved!</div>
